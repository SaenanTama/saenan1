...
<html>
    ...
    <body backround ="back.jpg">
        <br><br><br>
        <h1><marquee bgcolor="Turquoise"> PROYEK AKHIR MATA KULIAH INTERNET OF THING - CHRISTOPHER SAENAN CHRISTIANTAMA - G.211.21.0042</marquee></h1>
        ...
        snd.play();
            ...
            window.onload = function () {
                ...
                var chart = new CanvasJS.Chart("chartContainer", {
                    ...
                    data: [{
                        type: "splineArea", //tipe grafik yang digunakan, lihat di situsnya untuk lihat gaya lain
